...
\documentclass[final, 12pt, oneside, openright]{class_diss} %openright
%\documentclass[final, 12pt, oneside]{report}
%\documentclass[a4paper, oneside, openright, 12pt]{class_diss}
% +--------------------------------------------------------------------+
...
\usepackage{cancel} %para tachar formulas
%\usepackage{algpseudocode}%para usar pseudocodigo
