...
Este trabajo ha usado Google Cloud como plataforma de despliegue de la aplicación, explorar otras soluciones como AWS o Azure daría una perspectiva más general de qué entorno está más preparado para construir y utilizar modelos de deep learning.
