...
Podemos visualizar el diseño y el código de la aplicación en su repositorio oficial de GitHub\footnote{\url{https://github.com/openvinotoolkit/openvino}}.
...
Estos archivos son los que procesa su propia red de inferencia multiplataforma, ya que se encuentra preparada para poder trabajar con los mismos de manera concurrente, aprovechando así toda la potencia de los procesadores o GPU\cite{gpu_solution} actuales.
...
Los métodos exactos para la serialización del modelo varían según la versión de TensorFlow, en el caso presente versión 1.15.2. En cualquier caso ,la metodología de conversión exacta utilizada
...
Una vez exportado el modelo de \texit{Deep Learning} al formato estándar de TensorFlow tendremos a nuestra disposición los ficheros necesarios para realizar la transformación de estos al formato de OpenVINO.
...
\begin{lstlisting}[caption=Clase Python para la red de inferencia de TensorFlow.,
      label=b_label,
...
En la inicialización de la clase se lee el fichero ya optimizado del modelo de \texit{Deep Learning}, también se inicia la clase
...
Ambas soluciones implementan tecnologías de contenedores mantenidos de manera oficial por los fabricantes\footnote{\url{https://hub.docker.com/u/openvino}}\footnote{\url{https://hub.docker.com/r/tensorflow/tensorflow/}}, por lo que el uso de Docker es la mejor opción para transportar
